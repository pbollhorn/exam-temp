...
- Content-Based Filtering (CBF):
  CBF recommends movies by looking at the attributes of items a user has already enjoyed (e.g., genre, actors, director) and suggesting other movies with similar characteristics.
